...
// temps CPU est le temps passer sur chaque coeur dans sa propre unite de calcule , mais le temps elapsed est le temps globale d'execution  
...
fprintf("\n\n execution prod matrix parallel mode with %d threads\n",nb_taches);
#endif
...
#pragma omp parallel
{
	...
	fprintf(stdout, "\n\n"
			...
			"Temps CPU        :  %10.3E sec .\n"
			"Resultat partiel :  %10.3E %10.3E ..... %10.3E  %10.3E %10.3E .\n ",
